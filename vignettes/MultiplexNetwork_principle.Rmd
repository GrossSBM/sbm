...
mySampleMultiplexSBM <-
   ...
   type=type,
   seed = 1)
listSBM_PB <- mySampleMultiplexSBM$listSBM
...
mySampleMultiplexSBM <-
  sampleMultiplexSBM(
     ...
     dimLabels = c('row','col'),
     seed = 1)
listSBM_GG <- mySampleMultiplexSBM$listSBM
...
``` 
    ...
    -  2  Gaussian dependent Layers and three clusters 
    

```{r, echo = TRUE, eval = TRUE}
res_GG <- estimateMultiplexSBM(listSBM_GG,dependent = FALSE)
res_GG$storedModels
``` 
