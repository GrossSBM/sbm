...
This vignette illustrates the use of the `stimateMultipartiteSBM` function and the methods accompanying the R6 classes `multipartiteteSBMfit.
...
```{r load result, echo = FALSE, eval = FALSE}
load('resMultipartiteEcological.rda')
``` 

```{r MBM, echo = TRUE, eval = TRUE}
...
save(myMSBM,file='resMultipartiteEcological.rda')
``` 
