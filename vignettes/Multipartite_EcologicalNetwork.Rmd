...
link-citations: yes
vignette: >
  %\VignetteIndexEntry{Multipartite_EcologicalNetwork}
...
This vignette illustrates the use of the `estimateMultipartiteSBM` function and the methods accompanying the R6 classes `multipartiteteSBMfit.
