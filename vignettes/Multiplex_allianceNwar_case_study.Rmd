...
Since they don't have the same size, we choose to only consider nodes (countries) which were at war with at least one other country. This correponds to the first 83 nodes in the Alliance network.
...
```
We can retrive the clustering and compare it to the one obtained in the indepedent case.
```{r}
